export const metadata = {
  title:
    "Digital Services | Web Design, Branding & Marketing in the UK | Awais Digital Services",
  description:
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://awaisdigitalservices.co.uk/services/og.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://awaisdigitalservices.co.uk/services/og.jpg"],
  },
};
